...
const PromoBalanceShow = () => {
    const r = useRecordContext<RaffleFundsReceived>();
    if (!r) return null;
        ...
        <Card sx={{ m: 1 }}>
            <CardContent>
                <Stack spacing={1.25}>
                    ...
                    <Typography variant="body2">{r.from}</Typography>
...
export default PromoBalanceShow;
